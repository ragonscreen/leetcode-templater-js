...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2540_minimum-common-value/2540_minimum-common-value_response.txt',
                        'utf-8',
                ),
        );
});

describe('2540_minimum-common-value', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2540_minimum-common-value');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1052_grumpy-bookstore-owner/1052_grumpy-bookstore-owner_response.txt',
                        'utf-8',
                ),
        );
});

describe('1052_grumpy-bookstore-owner', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1052_grumpy-bookstore-owner');
        });
});

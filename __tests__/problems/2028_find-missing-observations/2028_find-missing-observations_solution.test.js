...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2028_find-missing-observations/2028_find-missing-observations_response.txt',
                        'utf-8',
                ),
        );
});

describe('2028_find-missing-observations', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2028_find-missing-observations');
        });
});

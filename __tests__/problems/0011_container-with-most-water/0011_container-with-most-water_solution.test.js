...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0011_container-with-most-water/0011_container-with-most-water_response.txt',
                        'utf-8',
                ),
        );
});

describe('0011_container-with-most-water', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0011_container-with-most-water');
        });
});

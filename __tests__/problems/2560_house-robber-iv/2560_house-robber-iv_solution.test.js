...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2560_house-robber-iv/2560_house-robber-iv_response.txt',
                        'utf-8',
                ),
        );
});

describe('2560_house-robber-iv', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2560_house-robber-iv');
        });
});

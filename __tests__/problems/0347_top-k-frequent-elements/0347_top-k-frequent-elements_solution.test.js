...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0347_top-k-frequent-elements/0347_top-k-frequent-elements_response.txt',
                        'utf-8',
                ),
        );
});

describe('0347_top-k-frequent-elements', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0347_top-k-frequent-elements');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2078_two-furthest-houses-with-different-colors/2078_two-furthest-houses-with-different-colors_response.txt',
                        'utf-8',
                ),
        );
});

describe('2078_two-furthest-houses-with-different-colors', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2078_two-furthest-houses-with-different-colors');
        });
});

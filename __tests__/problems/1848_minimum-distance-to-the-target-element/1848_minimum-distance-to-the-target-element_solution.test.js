...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1848_minimum-distance-to-the-target-element/1848_minimum-distance-to-the-target-element_response.txt',
                        'utf-8',
                ),
        );
});

describe('1848_minimum-distance-to-the-target-element', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1848_minimum-distance-to-the-target-element');
        });
});

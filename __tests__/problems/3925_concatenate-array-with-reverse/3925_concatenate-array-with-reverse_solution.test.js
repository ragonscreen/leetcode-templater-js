...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3925_concatenate-array-with-reverse/3925_concatenate-array-with-reverse_response.txt',
                        'utf-8',
                ),
        );
});

describe('3925_concatenate-array-with-reverse', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3925_concatenate-array-with-reverse');
        });
});

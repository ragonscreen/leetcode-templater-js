...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1769_minimum-number-of-operations-to-move-all-balls-to-each-box/1769_minimum-number-of-operations-to-move-all-balls-to-each-box_response.txt',
                        'utf-8',
                ),
        );
});

describe('1769_minimum-number-of-operations-to-move-all-balls-to-each-box', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1769_minimum-number-of-operations-to-move-all-balls-to-each-box');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0021_merge-two-sorted-lists/0021_merge-two-sorted-lists_response.txt',
                        'utf-8',
                ),
        );
});

describe('0021_merge-two-sorted-lists', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0021_merge-two-sorted-lists');
        });
});

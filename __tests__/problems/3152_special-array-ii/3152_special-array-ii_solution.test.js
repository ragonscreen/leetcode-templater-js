...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3152_special-array-ii/3152_special-array-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3152_special-array-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3152_special-array-ii');
        });
});

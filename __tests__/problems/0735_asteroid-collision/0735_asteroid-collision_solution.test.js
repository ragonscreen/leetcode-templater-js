...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0735_asteroid-collision/0735_asteroid-collision_response.txt',
                        'utf-8',
                ),
        );
});

describe('0735_asteroid-collision', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0735_asteroid-collision');
        });
});

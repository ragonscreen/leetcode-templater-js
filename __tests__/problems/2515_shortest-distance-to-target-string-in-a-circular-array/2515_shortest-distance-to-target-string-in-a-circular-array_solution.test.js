...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2515_shortest-distance-to-target-string-in-a-circular-array/2515_shortest-distance-to-target-string-in-a-circular-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('2515_shortest-distance-to-target-string-in-a-circular-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2515_shortest-distance-to-target-string-in-a-circular-array');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2779_maximum-beauty-of-an-array-after-applying-operation/2779_maximum-beauty-of-an-array-after-applying-operation_response.txt',
                        'utf-8',
                ),
        );
});

describe('2779_maximum-beauty-of-an-array-after-applying-operation', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2779_maximum-beauty-of-an-array-after-applying-operation');
        });
});

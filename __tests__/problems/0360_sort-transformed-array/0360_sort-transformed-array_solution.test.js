...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0360_sort-transformed-array/0360_sort-transformed-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('0360_sort-transformed-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0360_sort-transformed-array');
        });
});

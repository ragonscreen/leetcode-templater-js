...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2525_categorize-box-according-to-criteria/2525_categorize-box-according-to-criteria_response.txt',
                        'utf-8',
                ),
        );
});

describe('2525_categorize-box-according-to-criteria', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2525_categorize-box-according-to-criteria');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1652_defuse-the-bomb/1652_defuse-the-bomb_response.txt',
                        'utf-8',
                ),
        );
});

describe('1652_defuse-the-bomb', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1652_defuse-the-bomb');
        });
});

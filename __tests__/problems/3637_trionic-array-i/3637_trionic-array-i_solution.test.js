...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3637_trionic-array-i/3637_trionic-array-i_response.txt',
                        'utf-8',
                ),
        );
});

describe('3637_trionic-array-i', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3637_trionic-array-i');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3289_the-two-sneaky-numbers-of-digitville/3289_the-two-sneaky-numbers-of-digitville_response.txt',
                        'utf-8',
                ),
        );
});

describe('3289_the-two-sneaky-numbers-of-digitville', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3289_the-two-sneaky-numbers-of-digitville');
        });
});

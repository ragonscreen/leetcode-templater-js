...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2784_check-if-array-is-good/2784_check-if-array-is-good_response.txt',
                        'utf-8',
                ),
        );
});

describe('2784_check-if-array-is-good', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2784_check-if-array-is-good');
        });
});

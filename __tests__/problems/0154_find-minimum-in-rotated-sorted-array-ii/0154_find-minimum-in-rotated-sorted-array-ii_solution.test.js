...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0154_find-minimum-in-rotated-sorted-array-ii/0154_find-minimum-in-rotated-sorted-array-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0154_find-minimum-in-rotated-sorted-array-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0154_find-minimum-in-rotated-sorted-array-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1497_check-if-array-pairs-are-divisible-by-k/1497_check-if-array-pairs-are-divisible-by-k_response.txt',
                        'utf-8',
                ),
        );
});

describe('1497_check-if-array-pairs-are-divisible-by-k', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1497_check-if-array-pairs-are-divisible-by-k');
        });
});

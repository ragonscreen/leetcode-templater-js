...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0523_continuous-subarray-sum/0523_continuous-subarray-sum_response.txt',
                        'utf-8',
                ),
        );
});

describe('0523_continuous-subarray-sum', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0523_continuous-subarray-sum');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0811_subdomain-visit-count/0811_subdomain-visit-count_response.txt',
                        'utf-8',
                ),
        );
});

describe('0811_subdomain-visit-count', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0811_subdomain-visit-count');
        });
});

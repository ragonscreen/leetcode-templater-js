...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0041_first-missing-positive/0041_first-missing-positive_response.txt',
                        'utf-8',
                ),
        );
});

describe('0041_first-missing-positive', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0041_first-missing-positive');
        });
});

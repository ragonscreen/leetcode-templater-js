...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1106_parsing-a-boolean-expression/1106_parsing-a-boolean-expression_response.txt',
                        'utf-8',
                ),
        );
});

describe('1106_parsing-a-boolean-expression', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1106_parsing-a-boolean-expression');
        });
});

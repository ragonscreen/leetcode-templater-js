...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0875_koko-eating-bananas/0875_koko-eating-bananas_response.txt',
                        'utf-8',
                ),
        );
});

describe('0875_koko-eating-bananas', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0875_koko-eating-bananas');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2616_minimize-the-maximum-difference-of-pairs/2616_minimize-the-maximum-difference-of-pairs_response.txt',
                        'utf-8',
                ),
        );
});

describe('2616_minimize-the-maximum-difference-of-pairs', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2616_minimize-the-maximum-difference-of-pairs');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3273_minimum-amount-of-damage-dealt-to-bob/3273_minimum-amount-of-damage-dealt-to-bob_response.txt',
                        'utf-8',
                ),
        );
});

describe('3273_minimum-amount-of-damage-dealt-to-bob', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3273_minimum-amount-of-damage-dealt-to-bob');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0019_remove-nth-node-from-end-of-list/0019_remove-nth-node-from-end-of-list_response.txt',
                        'utf-8',
                ),
        );
});

describe('0019_remove-nth-node-from-end-of-list', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0019_remove-nth-node-from-end-of-list');
        });
});

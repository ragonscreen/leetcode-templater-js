...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0874_walking-robot-simulation/0874_walking-robot-simulation_response.txt',
                        'utf-8',
                ),
        );
});

describe('0874_walking-robot-simulation', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0874_walking-robot-simulation');
        });
});

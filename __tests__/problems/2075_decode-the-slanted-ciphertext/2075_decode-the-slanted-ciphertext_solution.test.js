...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2075_decode-the-slanted-ciphertext/2075_decode-the-slanted-ciphertext_response.txt',
                        'utf-8',
                ),
        );
});

describe('2075_decode-the-slanted-ciphertext', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2075_decode-the-slanted-ciphertext');
        });
});

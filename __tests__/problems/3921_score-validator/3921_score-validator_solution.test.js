...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3921_score-validator/3921_score-validator_response.txt',
                        'utf-8',
                ),
        );
});

describe('3921_score-validator', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3921_score-validator');
        });
});

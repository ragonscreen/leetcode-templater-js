...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0539_minimum-time-difference/0539_minimum-time-difference_response.txt',
                        'utf-8',
                ),
        );
});

describe('0539_minimum-time-difference', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0539_minimum-time-difference');
        });
});

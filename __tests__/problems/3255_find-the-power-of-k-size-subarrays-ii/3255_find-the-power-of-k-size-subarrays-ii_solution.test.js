...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3255_find-the-power-of-k-size-subarrays-ii/3255_find-the-power-of-k-size-subarrays-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3255_find-the-power-of-k-size-subarrays-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3255_find-the-power-of-k-size-subarrays-ii');
        });
});

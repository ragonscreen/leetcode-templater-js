...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0034_find-first-and-last-position-of-element-in-sorted-array/0034_find-first-and-last-position-of-element-in-sorted-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('0034_find-first-and-last-position-of-element-in-sorted-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0034_find-first-and-last-position-of-element-in-sorted-array');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0977_squares-of-a-sorted-array/0977_squares-of-a-sorted-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('0977_squares-of-a-sorted-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0977_squares-of-a-sorted-array');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0946_validate-stack-sequences/0946_validate-stack-sequences_response.txt',
                        'utf-8',
                ),
        );
});

describe('0946_validate-stack-sequences', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0946_validate-stack-sequences');
        });
});

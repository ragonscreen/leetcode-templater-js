...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1694_reformat-phone-number/1694_reformat-phone-number_response.txt',
                        'utf-8',
                ),
        );
});

describe('1694_reformat-phone-number', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1694_reformat-phone-number');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1760_minimum-limit-of-balls-in-a-bag/1760_minimum-limit-of-balls-in-a-bag_response.txt',
                        'utf-8',
                ),
        );
});

describe('1760_minimum-limit-of-balls-in-a-bag', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1760_minimum-limit-of-balls-in-a-bag');
        });
});

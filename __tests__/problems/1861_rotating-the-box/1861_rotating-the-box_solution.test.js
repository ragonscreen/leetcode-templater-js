...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1861_rotating-the-box/1861_rotating-the-box_response.txt',
                        'utf-8',
                ),
        );
});

describe('1861_rotating-the-box', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1861_rotating-the-box');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3926_count-valid-word-occurrences/3926_count-valid-word-occurrences_response.txt',
                        'utf-8',
                ),
        );
});

describe('3926_count-valid-word-occurrences', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3926_count-valid-word-occurrences');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2696_minimum-string-length-after-removing-substrings/2696_minimum-string-length-after-removing-substrings_response.txt',
                        'utf-8',
                ),
        );
});

describe('2696_minimum-string-length-after-removing-substrings', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2696_minimum-string-length-after-removing-substrings');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1249_minimum-remove-to-make-valid-parentheses/1249_minimum-remove-to-make-valid-parentheses_response.txt',
                        'utf-8',
                ),
        );
});

describe('1249_minimum-remove-to-make-valid-parentheses', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1249_minimum-remove-to-make-valid-parentheses');
        });
});

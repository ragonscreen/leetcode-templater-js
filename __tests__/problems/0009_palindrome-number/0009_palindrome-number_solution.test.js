...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0009_palindrome-number/0009_palindrome-number_response.txt',
                        'utf-8',
                ),
        );
});

describe('0009_palindrome-number', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0009_palindrome-number');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3301_maximize-the-total-height-of-unique-towers/3301_maximize-the-total-height-of-unique-towers_response.txt',
                        'utf-8',
                ),
        );
});

describe('3301_maximize-the-total-height-of-unique-towers', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3301_maximize-the-total-height-of-unique-towers');
        });
});

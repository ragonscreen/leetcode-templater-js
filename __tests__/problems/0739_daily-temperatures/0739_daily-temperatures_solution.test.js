...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0739_daily-temperatures/0739_daily-temperatures_response.txt',
                        'utf-8',
                ),
        );
});

describe('0739_daily-temperatures', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0739_daily-temperatures');
        });
});

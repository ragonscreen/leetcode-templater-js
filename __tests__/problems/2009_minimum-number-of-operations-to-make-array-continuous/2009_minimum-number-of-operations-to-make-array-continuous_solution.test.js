...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2009_minimum-number-of-operations-to-make-array-continuous/2009_minimum-number-of-operations-to-make-array-continuous_response.txt',
                        'utf-8',
                ),
        );
});

describe('2009_minimum-number-of-operations-to-make-array-continuous', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2009_minimum-number-of-operations-to-make-array-continuous');
        });
});

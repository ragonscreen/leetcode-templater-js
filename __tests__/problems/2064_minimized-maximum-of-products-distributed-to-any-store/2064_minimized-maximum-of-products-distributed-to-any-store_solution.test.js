...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2064_minimized-maximum-of-products-distributed-to-any-store/2064_minimized-maximum-of-products-distributed-to-any-store_response.txt',
                        'utf-8',
                ),
        );
});

describe('2064_minimized-maximum-of-products-distributed-to-any-store', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2064_minimized-maximum-of-products-distributed-to-any-store');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1572_matrix-diagonal-sum/1572_matrix-diagonal-sum_response.txt',
                        'utf-8',
                ),
        );
});

describe('1572_matrix-diagonal-sum', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1572_matrix-diagonal-sum');
        });
});

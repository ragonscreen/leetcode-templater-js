...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0169_majority-element/0169_majority-element_response.txt',
                        'utf-8',
                ),
        );
});

describe('0169_majority-element', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0169_majority-element');
        });
});

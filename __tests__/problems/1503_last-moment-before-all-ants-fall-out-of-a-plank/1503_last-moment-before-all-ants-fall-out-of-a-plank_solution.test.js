...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1503_last-moment-before-all-ants-fall-out-of-a-plank/1503_last-moment-before-all-ants-fall-out-of-a-plank_response.txt',
                        'utf-8',
                ),
        );
});

describe('1503_last-moment-before-all-ants-fall-out-of-a-plank', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1503_last-moment-before-all-ants-fall-out-of-a-plank');
        });
});

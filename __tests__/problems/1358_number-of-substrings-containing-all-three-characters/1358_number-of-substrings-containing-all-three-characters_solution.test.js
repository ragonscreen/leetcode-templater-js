...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1358_number-of-substrings-containing-all-three-characters/1358_number-of-substrings-containing-all-three-characters_response.txt',
                        'utf-8',
                ),
        );
});

describe('1358_number-of-substrings-containing-all-three-characters', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1358_number-of-substrings-containing-all-three-characters');
        });
});

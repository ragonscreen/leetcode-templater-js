...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0448_find-all-numbers-disappeared-in-an-array/0448_find-all-numbers-disappeared-in-an-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('0448_find-all-numbers-disappeared-in-an-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0448_find-all-numbers-disappeared-in-an-array');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2460_apply-operations-to-an-array/2460_apply-operations-to-an-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('2460_apply-operations-to-an-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2460_apply-operations-to-an-array');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1524_number-of-sub-arrays-with-odd-sum/1524_number-of-sub-arrays-with-odd-sum_response.txt',
                        'utf-8',
                ),
        );
});

describe('1524_number-of-sub-arrays-with-odd-sum', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1524_number-of-sub-arrays-with-odd-sum');
        });
});

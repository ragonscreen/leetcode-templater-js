...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0658_find-k-closest-elements/0658_find-k-closest-elements_response.txt',
                        'utf-8',
                ),
        );
});

describe('0658_find-k-closest-elements', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0658_find-k-closest-elements');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0159_longest-substring-with-at-most-two-distinct-characters/0159_longest-substring-with-at-most-two-distinct-characters_response.txt',
                        'utf-8',
                ),
        );
});

describe('0159_longest-substring-with-at-most-two-distinct-characters', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0159_longest-substring-with-at-most-two-distinct-characters');
        });
});

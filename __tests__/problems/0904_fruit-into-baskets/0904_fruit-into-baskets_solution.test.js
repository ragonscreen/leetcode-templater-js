...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0904_fruit-into-baskets/0904_fruit-into-baskets_response.txt',
                        'utf-8',
                ),
        );
});

describe('0904_fruit-into-baskets', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0904_fruit-into-baskets');
        });
});

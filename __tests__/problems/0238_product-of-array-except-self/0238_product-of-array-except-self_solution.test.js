...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0238_product-of-array-except-self/0238_product-of-array-except-self_response.txt',
                        'utf-8',
                ),
        );
});

describe('0238_product-of-array-except-self', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0238_product-of-array-except-self');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1984_minimum-difference-between-highest-and-lowest-of-k-scores/1984_minimum-difference-between-highest-and-lowest-of-k-scores_response.txt',
                        'utf-8',
                ),
        );
});

describe('1984_minimum-difference-between-highest-and-lowest-of-k-scores', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1984_minimum-difference-between-highest-and-lowest-of-k-scores');
        });
});

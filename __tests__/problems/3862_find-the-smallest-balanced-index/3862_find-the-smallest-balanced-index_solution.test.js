...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3862_find-the-smallest-balanced-index/3862_find-the-smallest-balanced-index_response.txt',
                        'utf-8',
                ),
        );
});

describe('3862_find-the-smallest-balanced-index', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3862_find-the-smallest-balanced-index');
        });
});

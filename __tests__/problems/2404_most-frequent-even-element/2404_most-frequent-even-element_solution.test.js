...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2404_most-frequent-even-element/2404_most-frequent-even-element_response.txt',
                        'utf-8',
                ),
        );
});

describe('2404_most-frequent-even-element', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2404_most-frequent-even-element');
        });
});

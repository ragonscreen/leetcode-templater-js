...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1701_average-waiting-time/1701_average-waiting-time_response.txt',
                        'utf-8',
                ),
        );
});

describe('1701_average-waiting-time', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1701_average-waiting-time');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2870_minimum-number-of-operations-to-make-array-empty/2870_minimum-number-of-operations-to-make-array-empty_response.txt',
                        'utf-8',
                ),
        );
});

describe('2870_minimum-number-of-operations-to-make-array-empty', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2870_minimum-number-of-operations-to-make-array-empty');
        });
});

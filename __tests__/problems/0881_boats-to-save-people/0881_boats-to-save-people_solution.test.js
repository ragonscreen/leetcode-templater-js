...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0881_boats-to-save-people/0881_boats-to-save-people_response.txt',
                        'utf-8',
                ),
        );
});

describe('0881_boats-to-save-people', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0881_boats-to-save-people');
        });
});

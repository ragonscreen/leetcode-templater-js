...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1004_max-consecutive-ones-iii/1004_max-consecutive-ones-iii_response.txt',
                        'utf-8',
                ),
        );
});

describe('1004_max-consecutive-ones-iii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1004_max-consecutive-ones-iii');
        });
});

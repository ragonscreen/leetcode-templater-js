...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0092_reverse-linked-list-ii/0092_reverse-linked-list-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0092_reverse-linked-list-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0092_reverse-linked-list-ii');
        });
});

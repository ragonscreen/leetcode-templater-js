...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0560_subarray-sum-equals-k/0560_subarray-sum-equals-k_response.txt',
                        'utf-8',
                ),
        );
});

describe('0560_subarray-sum-equals-k', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0560_subarray-sum-equals-k');
        });
});

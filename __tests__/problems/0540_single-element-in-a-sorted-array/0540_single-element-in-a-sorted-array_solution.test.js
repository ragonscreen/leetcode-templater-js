...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0540_single-element-in-a-sorted-array/0540_single-element-in-a-sorted-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('0540_single-element-in-a-sorted-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0540_single-element-in-a-sorted-array');
        });
});

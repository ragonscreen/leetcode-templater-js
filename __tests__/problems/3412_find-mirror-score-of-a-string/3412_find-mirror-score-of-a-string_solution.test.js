...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3412_find-mirror-score-of-a-string/3412_find-mirror-score-of-a-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('3412_find-mirror-score-of-a-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3412_find-mirror-score-of-a-string');
        });
});

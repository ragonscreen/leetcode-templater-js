...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0172_factorial-trailing-zeroes/0172_factorial-trailing-zeroes_response.txt',
                        'utf-8',
                ),
        );
});

describe('0172_factorial-trailing-zeroes', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0172_factorial-trailing-zeroes');
        });
});

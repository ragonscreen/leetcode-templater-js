...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1598_crawler-log-folder/1598_crawler-log-folder_response.txt',
                        'utf-8',
                ),
        );
});

describe('1598_crawler-log-folder', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1598_crawler-log-folder');
        });
});

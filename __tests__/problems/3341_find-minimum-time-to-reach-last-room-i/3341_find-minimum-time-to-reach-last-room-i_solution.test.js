...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3341_find-minimum-time-to-reach-last-room-i/3341_find-minimum-time-to-reach-last-room-i_response.txt',
                        'utf-8',
                ),
        );
});

describe('3341_find-minimum-time-to-reach-last-room-i', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3341_find-minimum-time-to-reach-last-room-i');
        });
});

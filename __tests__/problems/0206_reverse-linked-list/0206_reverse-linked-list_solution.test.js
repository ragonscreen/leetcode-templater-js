...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0206_reverse-linked-list/0206_reverse-linked-list_response.txt',
                        'utf-8',
                ),
        );
});

describe('0206_reverse-linked-list', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0206_reverse-linked-list');
        });
});

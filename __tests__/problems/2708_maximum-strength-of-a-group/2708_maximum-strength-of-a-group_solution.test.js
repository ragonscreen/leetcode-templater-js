...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2708_maximum-strength-of-a-group/2708_maximum-strength-of-a-group_response.txt',
                        'utf-8',
                ),
        );
});

describe('2708_maximum-strength-of-a-group', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2708_maximum-strength-of-a-group');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1498_number-of-subsequences-that-satisfy-the-given-sum-condition/1498_number-of-subsequences-that-satisfy-the-given-sum-condition_response.txt',
                        'utf-8',
                ),
        );
});

describe('1498_number-of-subsequences-that-satisfy-the-given-sum-condition', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1498_number-of-subsequences-that-satisfy-the-given-sum-condition');
        });
});

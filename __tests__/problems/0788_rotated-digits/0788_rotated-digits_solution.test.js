...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0788_rotated-digits/0788_rotated-digits_response.txt',
                        'utf-8',
                ),
        );
});

describe('0788_rotated-digits', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0788_rotated-digits');
        });
});

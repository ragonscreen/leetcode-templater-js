...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0121_best-time-to-buy-and-sell-stock/0121_best-time-to-buy-and-sell-stock_response.txt',
                        'utf-8',
                ),
        );
});

describe('0121_best-time-to-buy-and-sell-stock', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0121_best-time-to-buy-and-sell-stock');
        });
});

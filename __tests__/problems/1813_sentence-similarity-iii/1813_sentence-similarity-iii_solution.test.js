...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1813_sentence-similarity-iii/1813_sentence-similarity-iii_response.txt',
                        'utf-8',
                ),
        );
});

describe('1813_sentence-similarity-iii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1813_sentence-similarity-iii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1544_make-the-string-great/1544_make-the-string-great_response.txt',
                        'utf-8',
                ),
        );
});

describe('1544_make-the-string-great', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1544_make-the-string-great');
        });
});

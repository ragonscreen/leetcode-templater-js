...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3629_minimum-jumps-to-reach-end-via-prime-teleportation/3629_minimum-jumps-to-reach-end-via-prime-teleportation_response.txt',
                        'utf-8',
                ),
        );
});

describe('3629_minimum-jumps-to-reach-end-via-prime-teleportation', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3629_minimum-jumps-to-reach-end-via-prime-teleportation');
        });
});

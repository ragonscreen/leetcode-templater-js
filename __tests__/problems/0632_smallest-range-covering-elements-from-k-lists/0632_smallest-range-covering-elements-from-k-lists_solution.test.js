...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0632_smallest-range-covering-elements-from-k-lists/0632_smallest-range-covering-elements-from-k-lists_response.txt',
                        'utf-8',
                ),
        );
});

describe('0632_smallest-range-covering-elements-from-k-lists', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0632_smallest-range-covering-elements-from-k-lists');
        });
});

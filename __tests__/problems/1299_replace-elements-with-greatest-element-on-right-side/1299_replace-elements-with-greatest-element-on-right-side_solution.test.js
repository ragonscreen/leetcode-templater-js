...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1299_replace-elements-with-greatest-element-on-right-side/1299_replace-elements-with-greatest-element-on-right-side_response.txt',
                        'utf-8',
                ),
        );
});

describe('1299_replace-elements-with-greatest-element-on-right-side', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1299_replace-elements-with-greatest-element-on-right-side');
        });
});

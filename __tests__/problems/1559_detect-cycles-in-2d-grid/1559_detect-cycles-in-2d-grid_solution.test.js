...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1559_detect-cycles-in-2d-grid/1559_detect-cycles-in-2d-grid_response.txt',
                        'utf-8',
                ),
        );
});

describe('1559_detect-cycles-in-2d-grid', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1559_detect-cycles-in-2d-grid');
        });
});

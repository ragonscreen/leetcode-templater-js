...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3350_adjacent-increasing-subarrays-detection-ii/3350_adjacent-increasing-subarrays-detection-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3350_adjacent-increasing-subarrays-detection-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3350_adjacent-increasing-subarrays-detection-ii');
        });
});

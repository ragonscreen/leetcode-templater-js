...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0848_shifting-letters/0848_shifting-letters_response.txt',
                        'utf-8',
                ),
        );
});

describe('0848_shifting-letters', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0848_shifting-letters');
        });
});

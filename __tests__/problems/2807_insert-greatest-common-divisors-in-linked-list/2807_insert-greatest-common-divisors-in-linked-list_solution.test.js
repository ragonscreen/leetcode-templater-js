...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2807_insert-greatest-common-divisors-in-linked-list/2807_insert-greatest-common-divisors-in-linked-list_response.txt',
                        'utf-8',
                ),
        );
});

describe('2807_insert-greatest-common-divisors-in-linked-list', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2807_insert-greatest-common-divisors-in-linked-list');
        });
});

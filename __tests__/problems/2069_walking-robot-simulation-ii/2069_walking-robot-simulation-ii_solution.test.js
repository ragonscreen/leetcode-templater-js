...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2069_walking-robot-simulation-ii/2069_walking-robot-simulation-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('2069_walking-robot-simulation-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2069_walking-robot-simulation-ii');
        });
});

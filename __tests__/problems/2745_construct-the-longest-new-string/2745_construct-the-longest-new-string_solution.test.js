...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2745_construct-the-longest-new-string/2745_construct-the-longest-new-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('2745_construct-the-longest-new-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2745_construct-the-longest-new-string');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1855_maximum-distance-between-a-pair-of-values/1855_maximum-distance-between-a-pair-of-values_response.txt',
                        'utf-8',
                ),
        );
});

describe('1855_maximum-distance-between-a-pair-of-values', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1855_maximum-distance-between-a-pair-of-values');
        });
});

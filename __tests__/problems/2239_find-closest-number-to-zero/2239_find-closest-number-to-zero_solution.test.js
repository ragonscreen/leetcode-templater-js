...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2239_find-closest-number-to-zero/2239_find-closest-number-to-zero_response.txt',
                        'utf-8',
                ),
        );
});

describe('2239_find-closest-number-to-zero', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2239_find-closest-number-to-zero');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0122_best-time-to-buy-and-sell-stock-ii/0122_best-time-to-buy-and-sell-stock-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0122_best-time-to-buy-and-sell-stock-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0122_best-time-to-buy-and-sell-stock-ii');
        });
});

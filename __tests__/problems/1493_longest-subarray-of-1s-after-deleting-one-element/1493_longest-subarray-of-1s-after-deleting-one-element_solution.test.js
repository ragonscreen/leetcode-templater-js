...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1493_longest-subarray-of-1s-after-deleting-one-element/1493_longest-subarray-of-1s-after-deleting-one-element_response.txt',
                        'utf-8',
                ),
        );
});

describe('1493_longest-subarray-of-1s-after-deleting-one-element', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1493_longest-subarray-of-1s-after-deleting-one-element');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3932_count-k-th-roots-in-a-range/3932_count-k-th-roots-in-a-range_response.txt',
                        'utf-8',
                ),
        );
});

describe('3932_count-k-th-roots-in-a-range', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3932_count-k-th-roots-in-a-range');
        });
});

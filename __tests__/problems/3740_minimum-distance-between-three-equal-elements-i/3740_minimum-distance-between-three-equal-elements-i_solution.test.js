...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3740_minimum-distance-between-three-equal-elements-i/3740_minimum-distance-between-three-equal-elements-i_response.txt',
                        'utf-8',
                ),
        );
});

describe('3740_minimum-distance-between-three-equal-elements-i', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3740_minimum-distance-between-three-equal-elements-i');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0043_multiply-strings/0043_multiply-strings_response.txt',
                        'utf-8',
                ),
        );
});

describe('0043_multiply-strings', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0043_multiply-strings');
        });
});

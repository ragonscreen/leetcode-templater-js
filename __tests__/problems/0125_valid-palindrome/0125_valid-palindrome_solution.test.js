...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0125_valid-palindrome/0125_valid-palindrome_response.txt',
                        'utf-8',
                ),
        );
});

describe('0125_valid-palindrome', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0125_valid-palindrome');
        });
});

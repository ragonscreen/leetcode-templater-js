...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1537_get-the-maximum-score/1537_get-the-maximum-score_response.txt',
                        'utf-8',
                ),
        );
});

describe('1537_get-the-maximum-score', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1537_get-the-maximum-score');
        });
});

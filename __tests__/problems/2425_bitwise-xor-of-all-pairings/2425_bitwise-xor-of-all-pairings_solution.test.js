...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2425_bitwise-xor-of-all-pairings/2425_bitwise-xor-of-all-pairings_response.txt',
                        'utf-8',
                ),
        );
});

describe('2425_bitwise-xor-of-all-pairings', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2425_bitwise-xor-of-all-pairings');
        });
});

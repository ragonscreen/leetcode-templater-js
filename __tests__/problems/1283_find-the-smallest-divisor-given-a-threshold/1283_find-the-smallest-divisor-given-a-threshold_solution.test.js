...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1283_find-the-smallest-divisor-given-a-threshold/1283_find-the-smallest-divisor-given-a-threshold_response.txt',
                        'utf-8',
                ),
        );
});

describe('1283_find-the-smallest-divisor-given-a-threshold', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1283_find-the-smallest-divisor-given-a-threshold');
        });
});

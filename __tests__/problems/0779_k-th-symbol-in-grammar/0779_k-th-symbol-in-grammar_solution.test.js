...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0779_k-th-symbol-in-grammar/0779_k-th-symbol-in-grammar_response.txt',
                        'utf-8',
                ),
        );
});

describe('0779_k-th-symbol-in-grammar', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0779_k-th-symbol-in-grammar');
        });
});

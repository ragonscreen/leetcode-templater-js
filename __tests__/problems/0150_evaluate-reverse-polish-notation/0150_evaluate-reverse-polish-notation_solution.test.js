...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0150_evaluate-reverse-polish-notation/0150_evaluate-reverse-polish-notation_response.txt',
                        'utf-8',
                ),
        );
});

describe('0150_evaluate-reverse-polish-notation', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0150_evaluate-reverse-polish-notation');
        });
});

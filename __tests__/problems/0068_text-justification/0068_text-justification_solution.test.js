...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0068_text-justification/0068_text-justification_response.txt',
                        'utf-8',
                ),
        );
});

describe('0068_text-justification', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0068_text-justification');
        });
});

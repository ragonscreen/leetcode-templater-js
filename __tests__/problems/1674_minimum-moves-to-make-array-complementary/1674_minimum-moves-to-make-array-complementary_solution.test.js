...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1674_minimum-moves-to-make-array-complementary/1674_minimum-moves-to-make-array-complementary_response.txt',
                        'utf-8',
                ),
        );
});

describe('1674_minimum-moves-to-make-array-complementary', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1674_minimum-moves-to-make-array-complementary');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0657_robot-return-to-origin/0657_robot-return-to-origin_response.txt',
                        'utf-8',
                ),
        );
});

describe('0657_robot-return-to-origin', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0657_robot-return-to-origin');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1679_max-number-of-k-sum-pairs/1679_max-number-of-k-sum-pairs_response.txt',
                        'utf-8',
                ),
        );
});

describe('1679_max-number-of-k-sum-pairs', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1679_max-number-of-k-sum-pairs');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3914_minimum-operations-to-make-array-non-decreasing/3914_minimum-operations-to-make-array-non-decreasing_response.txt',
                        'utf-8',
                ),
        );
});

describe('3914_minimum-operations-to-make-array-non-decreasing', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3914_minimum-operations-to-make-array-non-decreasing');
        });
});

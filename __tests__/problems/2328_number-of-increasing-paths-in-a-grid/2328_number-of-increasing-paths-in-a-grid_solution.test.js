...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2328_number-of-increasing-paths-in-a-grid/2328_number-of-increasing-paths-in-a-grid_response.txt',
                        'utf-8',
                ),
        );
});

describe('2328_number-of-increasing-paths-in-a-grid', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2328_number-of-increasing-paths-in-a-grid');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2001_number-of-pairs-of-interchangeable-rectangles/2001_number-of-pairs-of-interchangeable-rectangles_response.txt',
                        'utf-8',
                ),
        );
});

describe('2001_number-of-pairs-of-interchangeable-rectangles', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2001_number-of-pairs-of-interchangeable-rectangles');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1512_number-of-good-pairs/1512_number-of-good-pairs_response.txt',
                        'utf-8',
                ),
        );
});

describe('1512_number-of-good-pairs', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1512_number-of-good-pairs');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2149_rearrange-array-elements-by-sign/2149_rearrange-array-elements-by-sign_response.txt',
                        'utf-8',
                ),
        );
});

describe('2149_rearrange-array-elements-by-sign', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2149_rearrange-array-elements-by-sign');
        });
});

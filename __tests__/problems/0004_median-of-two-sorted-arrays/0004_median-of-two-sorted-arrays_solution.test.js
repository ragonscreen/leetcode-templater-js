...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0004_median-of-two-sorted-arrays/0004_median-of-two-sorted-arrays_response.txt',
                        'utf-8',
                ),
        );
});

describe('0004_median-of-two-sorted-arrays', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0004_median-of-two-sorted-arrays');
        });
});

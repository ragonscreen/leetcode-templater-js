...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0455_assign-cookies/0455_assign-cookies_response.txt',
                        'utf-8',
                ),
        );
});

describe('0455_assign-cookies', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0455_assign-cookies');
        });
});

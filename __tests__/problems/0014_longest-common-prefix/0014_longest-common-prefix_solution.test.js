...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0014_longest-common-prefix/0014_longest-common-prefix_response.txt',
                        'utf-8',
                ),
        );
});

describe('0014_longest-common-prefix', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0014_longest-common-prefix');
        });
});

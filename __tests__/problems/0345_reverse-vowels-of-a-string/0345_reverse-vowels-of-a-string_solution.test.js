...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0345_reverse-vowels-of-a-string/0345_reverse-vowels-of-a-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('0345_reverse-vowels-of-a-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0345_reverse-vowels-of-a-string');
        });
});

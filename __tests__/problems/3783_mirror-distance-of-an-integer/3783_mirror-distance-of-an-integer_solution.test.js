...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3783_mirror-distance-of-an-integer/3783_mirror-distance-of-an-integer_response.txt',
                        'utf-8',
                ),
        );
});

describe('3783_mirror-distance-of-an-integer', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3783_mirror-distance-of-an-integer');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0002_add-two-numbers/0002_add-two-numbers_response.txt',
                        'utf-8',
                ),
        );
});

describe('0002_add-two-numbers', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0002_add-two-numbers');
        });
});

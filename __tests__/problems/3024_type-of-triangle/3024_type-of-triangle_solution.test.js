...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3024_type-of-triangle/3024_type-of-triangle_response.txt',
                        'utf-8',
                ),
        );
});

describe('3024_type-of-triangle', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3024_type-of-triangle');
        });
});

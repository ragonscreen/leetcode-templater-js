...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3355_zero-array-transformation-i/3355_zero-array-transformation-i_response.txt',
                        'utf-8',
                ),
        );
});

describe('3355_zero-array-transformation-i', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3355_zero-array-transformation-i');
        });
});

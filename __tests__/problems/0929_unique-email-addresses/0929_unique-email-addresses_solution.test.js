...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0929_unique-email-addresses/0929_unique-email-addresses_response.txt',
                        'utf-8',
                ),
        );
});

describe('0929_unique-email-addresses', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0929_unique-email-addresses');
        });
});

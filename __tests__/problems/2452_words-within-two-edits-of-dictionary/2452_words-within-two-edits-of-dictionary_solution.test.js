...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2452_words-within-two-edits-of-dictionary/2452_words-within-two-edits-of-dictionary_response.txt',
                        'utf-8',
                ),
        );
});

describe('2452_words-within-two-edits-of-dictionary', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2452_words-within-two-edits-of-dictionary');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0074_search-a-2d-matrix/0074_search-a-2d-matrix_response.txt',
                        'utf-8',
                ),
        );
});

describe('0074_search-a-2d-matrix', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0074_search-a-2d-matrix');
        });
});

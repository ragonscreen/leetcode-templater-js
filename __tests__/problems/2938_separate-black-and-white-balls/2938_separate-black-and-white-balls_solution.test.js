...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2938_separate-black-and-white-balls/2938_separate-black-and-white-balls_response.txt',
                        'utf-8',
                ),
        );
});

describe('2938_separate-black-and-white-balls', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2938_separate-black-and-white-balls');
        });
});

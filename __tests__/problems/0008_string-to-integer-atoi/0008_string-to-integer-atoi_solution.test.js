...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0008_string-to-integer-atoi/0008_string-to-integer-atoi_response.txt',
                        'utf-8',
                ),
        );
});

describe('0008_string-to-integer-atoi', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0008_string-to-integer-atoi');
        });
});

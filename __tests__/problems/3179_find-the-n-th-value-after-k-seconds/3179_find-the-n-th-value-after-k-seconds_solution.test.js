...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3179_find-the-n-th-value-after-k-seconds/3179_find-the-n-th-value-after-k-seconds_response.txt',
                        'utf-8',
                ),
        );
});

describe('3179_find-the-n-th-value-after-k-seconds', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3179_find-the-n-th-value-after-k-seconds');
        });
});

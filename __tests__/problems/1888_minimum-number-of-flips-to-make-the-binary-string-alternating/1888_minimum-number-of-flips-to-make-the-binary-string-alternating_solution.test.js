...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1888_minimum-number-of-flips-to-make-the-binary-string-alternating/1888_minimum-number-of-flips-to-make-the-binary-string-alternating_response.txt',
                        'utf-8',
                ),
        );
});

describe('1888_minimum-number-of-flips-to-make-the-binary-string-alternating', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1888_minimum-number-of-flips-to-make-the-binary-string-alternating');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2244_minimum-rounds-to-complete-all-tasks/2244_minimum-rounds-to-complete-all-tasks_response.txt',
                        'utf-8',
                ),
        );
});

describe('2244_minimum-rounds-to-complete-all-tasks', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2244_minimum-rounds-to-complete-all-tasks');
        });
});

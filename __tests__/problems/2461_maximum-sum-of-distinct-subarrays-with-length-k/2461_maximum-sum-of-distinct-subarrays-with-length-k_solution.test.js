...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2461_maximum-sum-of-distinct-subarrays-with-length-k/2461_maximum-sum-of-distinct-subarrays-with-length-k_response.txt',
                        'utf-8',
                ),
        );
});

describe('2461_maximum-sum-of-distinct-subarrays-with-length-k', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2461_maximum-sum-of-distinct-subarrays-with-length-k');
        });
});

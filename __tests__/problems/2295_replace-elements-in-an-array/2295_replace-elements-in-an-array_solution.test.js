...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2295_replace-elements-in-an-array/2295_replace-elements-in-an-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('2295_replace-elements-in-an-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2295_replace-elements-in-an-array');
        });
});

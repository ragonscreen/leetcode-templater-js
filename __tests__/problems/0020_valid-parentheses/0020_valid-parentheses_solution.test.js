...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0020_valid-parentheses/0020_valid-parentheses_response.txt',
                        'utf-8',
                ),
        );
});

describe('0020_valid-parentheses', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0020_valid-parentheses');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2658_maximum-number-of-fish-in-a-grid/2658_maximum-number-of-fish-in-a-grid_response.txt',
                        'utf-8',
                ),
        );
});

describe('2658_maximum-number-of-fish-in-a-grid', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2658_maximum-number-of-fish-in-a-grid');
        });
});

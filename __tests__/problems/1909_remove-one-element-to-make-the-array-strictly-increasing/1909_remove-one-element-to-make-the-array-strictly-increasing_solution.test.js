...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1909_remove-one-element-to-make-the-array-strictly-increasing/1909_remove-one-element-to-make-the-array-strictly-increasing_response.txt',
                        'utf-8',
                ),
        );
});

describe('1909_remove-one-element-to-make-the-array-strictly-increasing', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1909_remove-one-element-to-make-the-array-strictly-increasing');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2931_maximum-spending-after-buying-items/2931_maximum-spending-after-buying-items_response.txt',
                        'utf-8',
                ),
        );
});

describe('2931_maximum-spending-after-buying-items', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2931_maximum-spending-after-buying-items');
        });
});

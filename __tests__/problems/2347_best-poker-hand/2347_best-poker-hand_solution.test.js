...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2347_best-poker-hand/2347_best-poker-hand_response.txt',
                        'utf-8',
                ),
        );
});

describe('2347_best-poker-hand', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2347_best-poker-hand');
        });
});

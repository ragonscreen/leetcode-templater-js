...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2405_optimal-partition-of-string/2405_optimal-partition-of-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('2405_optimal-partition-of-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2405_optimal-partition-of-string');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0462_minimum-moves-to-equal-array-elements-ii/0462_minimum-moves-to-equal-array-elements-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0462_minimum-moves-to-equal-array-elements-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0462_minimum-moves-to-equal-array-elements-ii');
        });
});

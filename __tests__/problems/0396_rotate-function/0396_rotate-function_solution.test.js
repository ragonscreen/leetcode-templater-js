...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0396_rotate-function/0396_rotate-function_response.txt',
                        'utf-8',
                ),
        );
});

describe('0396_rotate-function', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0396_rotate-function');
        });
});

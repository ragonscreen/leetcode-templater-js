...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2958_length-of-longest-subarray-with-at-most-k-frequency/2958_length-of-longest-subarray-with-at-most-k-frequency_response.txt',
                        'utf-8',
                ),
        );
});

describe('2958_length-of-longest-subarray-with-at-most-k-frequency', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2958_length-of-longest-subarray-with-at-most-k-frequency');
        });
});

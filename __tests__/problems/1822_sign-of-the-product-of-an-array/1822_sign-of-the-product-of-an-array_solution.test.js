...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1822_sign-of-the-product-of-an-array/1822_sign-of-the-product-of-an-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('1822_sign-of-the-product-of-an-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1822_sign-of-the-product-of-an-array');
        });
});

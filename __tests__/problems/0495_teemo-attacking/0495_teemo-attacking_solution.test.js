...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0495_teemo-attacking/0495_teemo-attacking_response.txt',
                        'utf-8',
                ),
        );
});

describe('0495_teemo-attacking', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0495_teemo-attacking');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2300_successful-pairs-of-spells-and-potions/2300_successful-pairs-of-spells-and-potions_response.txt',
                        'utf-8',
                ),
        );
});

describe('2300_successful-pairs-of-spells-and-potions', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2300_successful-pairs-of-spells-and-potions');
        });
});

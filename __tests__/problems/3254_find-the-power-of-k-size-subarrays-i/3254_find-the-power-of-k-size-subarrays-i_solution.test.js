...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3254_find-the-power-of-k-size-subarrays-i/3254_find-the-power-of-k-size-subarrays-i_response.txt',
                        'utf-8',
                ),
        );
});

describe('3254_find-the-power-of-k-size-subarrays-i', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3254_find-the-power-of-k-size-subarrays-i');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2615_sum-of-distances/2615_sum-of-distances_response.txt',
                        'utf-8',
                ),
        );
});

describe('2615_sum-of-distances', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2615_sum-of-distances');
        });
});

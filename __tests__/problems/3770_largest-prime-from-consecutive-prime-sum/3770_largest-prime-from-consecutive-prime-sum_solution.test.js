...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3770_largest-prime-from-consecutive-prime-sum/3770_largest-prime-from-consecutive-prime-sum_response.txt',
                        'utf-8',
                ),
        );
});

describe('3770_largest-prime-from-consecutive-prime-sum', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3770_largest-prime-from-consecutive-prime-sum');
        });
});

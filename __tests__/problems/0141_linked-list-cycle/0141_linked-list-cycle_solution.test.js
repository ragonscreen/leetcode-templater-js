...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0141_linked-list-cycle/0141_linked-list-cycle_response.txt',
                        'utf-8',
                ),
        );
});

describe('0141_linked-list-cycle', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0141_linked-list-cycle');
        });
});

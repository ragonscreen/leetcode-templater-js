...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0724_find-pivot-index/0724_find-pivot-index_response.txt',
                        'utf-8',
                ),
        );
});

describe('0724_find-pivot-index', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0724_find-pivot-index');
        });
});

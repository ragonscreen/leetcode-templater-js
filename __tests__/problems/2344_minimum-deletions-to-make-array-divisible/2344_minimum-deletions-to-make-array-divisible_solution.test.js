...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2344_minimum-deletions-to-make-array-divisible/2344_minimum-deletions-to-make-array-divisible_response.txt',
                        'utf-8',
                ),
        );
});

describe('2344_minimum-deletions-to-make-array-divisible', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2344_minimum-deletions-to-make-array-divisible');
        });
});

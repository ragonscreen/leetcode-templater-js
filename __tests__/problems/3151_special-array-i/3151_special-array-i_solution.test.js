...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3151_special-array-i/3151_special-array-i_response.txt',
                        'utf-8',
                ),
        );
});

describe('3151_special-array-i', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3151_special-array-i');
        });
});

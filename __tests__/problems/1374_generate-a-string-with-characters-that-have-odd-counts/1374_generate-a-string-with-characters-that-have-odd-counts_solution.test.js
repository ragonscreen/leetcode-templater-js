...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1374_generate-a-string-with-characters-that-have-odd-counts/1374_generate-a-string-with-characters-that-have-odd-counts_response.txt',
                        'utf-8',
                ),
        );
});

describe('1374_generate-a-string-with-characters-that-have-odd-counts', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1374_generate-a-string-with-characters-that-have-odd-counts');
        });
});

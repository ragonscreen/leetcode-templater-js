...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3703_remove-k-balanced-substrings/3703_remove-k-balanced-substrings_response.txt',
                        'utf-8',
                ),
        );
});

describe('3703_remove-k-balanced-substrings', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3703_remove-k-balanced-substrings');
        });
});

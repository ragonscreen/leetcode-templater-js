...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1248_count-number-of-nice-subarrays/1248_count-number-of-nice-subarrays_response.txt',
                        'utf-8',
                ),
        );
});

describe('1248_count-number-of-nice-subarrays', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1248_count-number-of-nice-subarrays');
        });
});

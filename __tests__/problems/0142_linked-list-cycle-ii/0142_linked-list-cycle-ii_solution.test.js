...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0142_linked-list-cycle-ii/0142_linked-list-cycle-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0142_linked-list-cycle-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0142_linked-list-cycle-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0227_basic-calculator-ii/0227_basic-calculator-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0227_basic-calculator-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0227_basic-calculator-ii');
        });
});

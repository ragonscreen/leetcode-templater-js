...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1968_array-with-elements-not-equal-to-average-of-neighbors/1968_array-with-elements-not-equal-to-average-of-neighbors_response.txt',
                        'utf-8',
                ),
        );
});

describe('1968_array-with-elements-not-equal-to-average-of-neighbors', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1968_array-with-elements-not-equal-to-average-of-neighbors');
        });
});

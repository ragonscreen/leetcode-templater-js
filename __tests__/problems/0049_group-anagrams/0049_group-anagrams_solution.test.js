...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0049_group-anagrams/0049_group-anagrams_response.txt',
                        'utf-8',
                ),
        );
});

describe('0049_group-anagrams', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0049_group-anagrams');
        });
});

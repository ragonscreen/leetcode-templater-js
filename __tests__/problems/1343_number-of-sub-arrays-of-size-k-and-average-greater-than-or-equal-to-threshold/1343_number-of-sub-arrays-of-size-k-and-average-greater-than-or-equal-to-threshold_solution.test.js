...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1343_number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold/1343_number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold_response.txt',
                        'utf-8',
                ),
        );
});

describe('1343_number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1343_number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold');
        });
});

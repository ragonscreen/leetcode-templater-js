...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1750_minimum-length-of-string-after-deleting-similar-ends/1750_minimum-length-of-string-after-deleting-similar-ends_response.txt',
                        'utf-8',
                ),
        );
});

describe('1750_minimum-length-of-string-after-deleting-similar-ends', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1750_minimum-length-of-string-after-deleting-similar-ends');
        });
});

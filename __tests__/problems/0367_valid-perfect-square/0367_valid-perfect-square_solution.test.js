...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0367_valid-perfect-square/0367_valid-perfect-square_response.txt',
                        'utf-8',
                ),
        );
});

describe('0367_valid-perfect-square', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0367_valid-perfect-square');
        });
});

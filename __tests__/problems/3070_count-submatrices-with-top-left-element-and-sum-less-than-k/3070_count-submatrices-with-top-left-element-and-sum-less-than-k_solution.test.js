...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3070_count-submatrices-with-top-left-element-and-sum-less-than-k/3070_count-submatrices-with-top-left-element-and-sum-less-than-k_response.txt',
                        'utf-8',
                ),
        );
});

describe('3070_count-submatrices-with-top-left-element-and-sum-less-than-k', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3070_count-submatrices-with-top-left-element-and-sum-less-than-k');
        });
});

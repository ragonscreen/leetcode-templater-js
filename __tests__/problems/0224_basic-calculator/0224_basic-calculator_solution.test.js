...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0224_basic-calculator/0224_basic-calculator_response.txt',
                        'utf-8',
                ),
        );
});

describe('0224_basic-calculator', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0224_basic-calculator');
        });
});

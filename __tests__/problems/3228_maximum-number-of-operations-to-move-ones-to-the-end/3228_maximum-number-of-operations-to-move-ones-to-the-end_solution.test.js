...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3228_maximum-number-of-operations-to-move-ones-to-the-end/3228_maximum-number-of-operations-to-move-ones-to-the-end_response.txt',
                        'utf-8',
                ),
        );
});

describe('3228_maximum-number-of-operations-to-move-ones-to-the-end', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3228_maximum-number-of-operations-to-move-ones-to-the-end');
        });
});

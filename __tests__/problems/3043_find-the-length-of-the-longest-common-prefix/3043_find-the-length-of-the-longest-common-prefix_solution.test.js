...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3043_find-the-length-of-the-longest-common-prefix/3043_find-the-length-of-the-longest-common-prefix_response.txt',
                        'utf-8',
                ),
        );
});

describe('3043_find-the-length-of-the-longest-common-prefix', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3043_find-the-length-of-the-longest-common-prefix');
        });
});

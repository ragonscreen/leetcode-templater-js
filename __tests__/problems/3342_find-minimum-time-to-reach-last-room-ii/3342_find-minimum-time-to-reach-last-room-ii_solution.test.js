...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3342_find-minimum-time-to-reach-last-room-ii/3342_find-minimum-time-to-reach-last-room-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3342_find-minimum-time-to-reach-last-room-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3342_find-minimum-time-to-reach-last-room-ii');
        });
});

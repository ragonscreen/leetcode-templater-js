...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2379_minimum-recolors-to-get-k-consecutive-black-blocks/2379_minimum-recolors-to-get-k-consecutive-black-blocks_response.txt',
                        'utf-8',
                ),
        );
});

describe('2379_minimum-recolors-to-get-k-consecutive-black-blocks', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2379_minimum-recolors-to-get-k-consecutive-black-blocks');
        });
});

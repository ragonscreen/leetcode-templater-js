...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1929_concatenation-of-array/1929_concatenation-of-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('1929_concatenation-of-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1929_concatenation-of-array');
        });
});

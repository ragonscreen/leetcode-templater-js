...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0162_find-peak-element/0162_find-peak-element_response.txt',
                        'utf-8',
                ),
        );
});

describe('0162_find-peak-element', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0162_find-peak-element');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0013_roman-to-integer/0013_roman-to-integer_response.txt',
                        'utf-8',
                ),
        );
});

describe('0013_roman-to-integer', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0013_roman-to-integer');
        });
});

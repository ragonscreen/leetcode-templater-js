...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3306_count-of-substrings-containing-every-vowel-and-k-consonants-ii/3306_count-of-substrings-containing-every-vowel-and-k-consonants-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3306_count-of-substrings-containing-every-vowel-and-k-consonants-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3306_count-of-substrings-containing-every-vowel-and-k-consonants-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2428_maximum-sum-of-an-hourglass/2428_maximum-sum-of-an-hourglass_response.txt',
                        'utf-8',
                ),
        );
});

describe('2428_maximum-sum-of-an-hourglass', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2428_maximum-sum-of-an-hourglass');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0088_merge-sorted-array/0088_merge-sorted-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('0088_merge-sorted-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0088_merge-sorted-array');
        });
});

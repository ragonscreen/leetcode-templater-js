...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0240_search-a-2d-matrix-ii/0240_search-a-2d-matrix-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0240_search-a-2d-matrix-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0240_search-a-2d-matrix-ii');
        });
});

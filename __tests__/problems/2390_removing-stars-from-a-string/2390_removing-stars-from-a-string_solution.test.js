...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2390_removing-stars-from-a-string/2390_removing-stars-from-a-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('2390_removing-stars-from-a-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2390_removing-stars-from-a-string');
        });
});

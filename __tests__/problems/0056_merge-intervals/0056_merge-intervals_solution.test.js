...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0056_merge-intervals/0056_merge-intervals_response.txt',
                        'utf-8',
                ),
        );
});

describe('0056_merge-intervals', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0056_merge-intervals');
        });
});

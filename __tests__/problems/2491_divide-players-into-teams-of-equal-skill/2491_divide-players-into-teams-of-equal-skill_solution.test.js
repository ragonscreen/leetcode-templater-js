...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2491_divide-players-into-teams-of-equal-skill/2491_divide-players-into-teams-of-equal-skill_response.txt',
                        'utf-8',
                ),
        );
});

describe('2491_divide-players-into-teams-of-equal-skill', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2491_divide-players-into-teams-of-equal-skill');
        });
});

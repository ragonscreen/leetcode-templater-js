...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1041_robot-bounded-in-circle/1041_robot-bounded-in-circle_response.txt',
                        'utf-8',
                ),
        );
});

describe('1041_robot-bounded-in-circle', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1041_robot-bounded-in-circle');
        });
});

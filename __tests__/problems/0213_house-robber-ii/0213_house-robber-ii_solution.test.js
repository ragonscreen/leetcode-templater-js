...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0213_house-robber-ii/0213_house-robber-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0213_house-robber-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0213_house-robber-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3904_smallest-stable-index-ii/3904_smallest-stable-index-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3904_smallest-stable-index-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3904_smallest-stable-index-ii');
        });
});

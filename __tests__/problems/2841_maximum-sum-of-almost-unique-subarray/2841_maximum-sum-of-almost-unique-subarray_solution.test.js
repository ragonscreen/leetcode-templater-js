...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2841_maximum-sum-of-almost-unique-subarray/2841_maximum-sum-of-almost-unique-subarray_response.txt',
                        'utf-8',
                ),
        );
});

describe('2841_maximum-sum-of-almost-unique-subarray', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2841_maximum-sum-of-almost-unique-subarray');
        });
});

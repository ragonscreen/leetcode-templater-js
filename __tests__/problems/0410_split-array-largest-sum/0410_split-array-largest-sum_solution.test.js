...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0410_split-array-largest-sum/0410_split-array-largest-sum_response.txt',
                        'utf-8',
                ),
        );
});

describe('0410_split-array-largest-sum', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0410_split-array-largest-sum');
        });
});

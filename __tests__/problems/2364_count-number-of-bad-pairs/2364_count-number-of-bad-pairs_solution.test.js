...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2364_count-number-of-bad-pairs/2364_count-number-of-bad-pairs_response.txt',
                        'utf-8',
                ),
        );
});

describe('2364_count-number-of-bad-pairs', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2364_count-number-of-bad-pairs');
        });
});

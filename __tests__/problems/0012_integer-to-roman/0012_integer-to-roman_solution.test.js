...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0012_integer-to-roman/0012_integer-to-roman_response.txt',
                        'utf-8',
                ),
        );
});

describe('0012_integer-to-roman', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0012_integer-to-roman');
        });
});

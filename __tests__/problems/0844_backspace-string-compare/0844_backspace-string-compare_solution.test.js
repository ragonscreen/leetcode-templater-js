...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0844_backspace-string-compare/0844_backspace-string-compare_response.txt',
                        'utf-8',
                ),
        );
});

describe('0844_backspace-string-compare', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0844_backspace-string-compare');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2610_convert-an-array-into-a-2d-array-with-conditions/2610_convert-an-array-into-a-2d-array-with-conditions_response.txt',
                        'utf-8',
                ),
        );
});

describe('2610_convert-an-array-into-a-2d-array-with-conditions', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2610_convert-an-array-into-a-2d-array-with-conditions');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0901_online-stock-span/0901_online-stock-span_response.txt',
                        'utf-8',
                ),
        );
});

describe('0901_online-stock-span', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0901_online-stock-span');
        });
});

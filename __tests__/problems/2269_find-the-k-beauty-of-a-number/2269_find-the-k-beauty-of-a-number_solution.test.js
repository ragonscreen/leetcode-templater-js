...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2269_find-the-k-beauty-of-a-number/2269_find-the-k-beauty-of-a-number_response.txt',
                        'utf-8',
                ),
        );
});

describe('2269_find-the-k-beauty-of-a-number', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2269_find-the-k-beauty-of-a-number');
        });
});

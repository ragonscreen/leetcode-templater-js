...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2810_faulty-keyboard/2810_faulty-keyboard_response.txt',
                        'utf-8',
                ),
        );
});

describe('2810_faulty-keyboard', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2810_faulty-keyboard');
        });
});

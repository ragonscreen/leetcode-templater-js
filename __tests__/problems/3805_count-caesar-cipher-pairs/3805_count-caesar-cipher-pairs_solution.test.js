...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3805_count-caesar-cipher-pairs/3805_count-caesar-cipher-pairs_response.txt',
                        'utf-8',
                ),
        );
});

describe('3805_count-caesar-cipher-pairs', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3805_count-caesar-cipher-pairs');
        });
});

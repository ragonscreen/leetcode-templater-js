...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2381_shifting-letters-ii/2381_shifting-letters-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('2381_shifting-letters-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2381_shifting-letters-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0073_set-matrix-zeroes/0073_set-matrix-zeroes_response.txt',
                        'utf-8',
                ),
        );
});

describe('0073_set-matrix-zeroes', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0073_set-matrix-zeroes');
        });
});

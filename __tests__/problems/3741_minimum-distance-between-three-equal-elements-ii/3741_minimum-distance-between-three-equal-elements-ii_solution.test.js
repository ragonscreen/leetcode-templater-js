...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3741_minimum-distance-between-three-equal-elements-ii/3741_minimum-distance-between-three-equal-elements-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3741_minimum-distance-between-three-equal-elements-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3741_minimum-distance-between-three-equal-elements-ii');
        });
});

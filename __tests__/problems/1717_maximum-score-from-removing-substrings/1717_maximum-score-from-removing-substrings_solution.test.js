...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1717_maximum-score-from-removing-substrings/1717_maximum-score-from-removing-substrings_response.txt',
                        'utf-8',
                ),
        );
});

describe('1717_maximum-score-from-removing-substrings', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1717_maximum-score-from-removing-substrings');
        });
});

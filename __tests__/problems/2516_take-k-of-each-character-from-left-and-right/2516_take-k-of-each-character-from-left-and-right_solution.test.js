...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2516_take-k-of-each-character-from-left-and-right/2516_take-k-of-each-character-from-left-and-right_response.txt',
                        'utf-8',
                ),
        );
});

describe('2516_take-k-of-each-character-from-left-and-right', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2516_take-k-of-each-character-from-left-and-right');
        });
});

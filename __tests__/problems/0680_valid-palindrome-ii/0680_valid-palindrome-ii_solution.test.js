...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0680_valid-palindrome-ii/0680_valid-palindrome-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0680_valid-palindrome-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0680_valid-palindrome-ii');
        });
});

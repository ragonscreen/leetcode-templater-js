...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2545_sort-the-students-by-their-kth-score/2545_sort-the-students-by-their-kth-score_response.txt',
                        'utf-8',
                ),
        );
});

describe('2545_sort-the-students-by-their-kth-score', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2545_sort-the-students-by-their-kth-score');
        });
});

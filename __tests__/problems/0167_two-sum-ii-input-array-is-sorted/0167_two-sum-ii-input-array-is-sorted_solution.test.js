...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0167_two-sum-ii-input-array-is-sorted/0167_two-sum-ii-input-array-is-sorted_response.txt',
                        'utf-8',
                ),
        );
});

describe('0167_two-sum-ii-input-array-is-sorted', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0167_two-sum-ii-input-array-is-sorted');
        });
});

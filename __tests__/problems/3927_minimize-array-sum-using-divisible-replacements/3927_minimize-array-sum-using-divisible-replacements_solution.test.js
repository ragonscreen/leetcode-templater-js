...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3927_minimize-array-sum-using-divisible-replacements/3927_minimize-array-sum-using-divisible-replacements_response.txt',
                        'utf-8',
                ),
        );
});

describe('3927_minimize-array-sum-using-divisible-replacements', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3927_minimize-array-sum-using-divisible-replacements');
        });
});

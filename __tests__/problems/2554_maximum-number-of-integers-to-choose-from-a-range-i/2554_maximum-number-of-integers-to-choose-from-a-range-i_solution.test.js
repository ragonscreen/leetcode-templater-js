...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2554_maximum-number-of-integers-to-choose-from-a-range-i/2554_maximum-number-of-integers-to-choose-from-a-range-i_response.txt',
                        'utf-8',
                ),
        );
});

describe('2554_maximum-number-of-integers-to-choose-from-a-range-i', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2554_maximum-number-of-integers-to-choose-from-a-range-i');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0713_subarray-product-less-than-k/0713_subarray-product-less-than-k_response.txt',
                        'utf-8',
                ),
        );
});

describe('0713_subarray-product-less-than-k', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0713_subarray-product-less-than-k');
        });
});

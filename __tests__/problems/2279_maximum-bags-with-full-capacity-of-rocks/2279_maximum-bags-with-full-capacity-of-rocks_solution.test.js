...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2279_maximum-bags-with-full-capacity-of-rocks/2279_maximum-bags-with-full-capacity-of-rocks_response.txt',
                        'utf-8',
                ),
        );
});

describe('2279_maximum-bags-with-full-capacity-of-rocks', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2279_maximum-bags-with-full-capacity-of-rocks');
        });
});

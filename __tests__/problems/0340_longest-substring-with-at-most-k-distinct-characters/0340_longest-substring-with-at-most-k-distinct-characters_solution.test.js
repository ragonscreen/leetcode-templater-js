...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0340_longest-substring-with-at-most-k-distinct-characters/0340_longest-substring-with-at-most-k-distinct-characters_response.txt',
                        'utf-8',
                ),
        );
});

describe('0340_longest-substring-with-at-most-k-distinct-characters', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0340_longest-substring-with-at-most-k-distinct-characters');
        });
});

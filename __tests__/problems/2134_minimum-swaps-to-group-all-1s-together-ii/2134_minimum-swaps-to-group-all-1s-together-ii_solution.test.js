...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2134_minimum-swaps-to-group-all-1s-together-ii/2134_minimum-swaps-to-group-all-1s-together-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('2134_minimum-swaps-to-group-all-1s-together-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2134_minimum-swaps-to-group-all-1s-together-ii');
        });
});

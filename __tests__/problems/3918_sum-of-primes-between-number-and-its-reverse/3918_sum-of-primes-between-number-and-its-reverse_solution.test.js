...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3918_sum-of-primes-between-number-and-its-reverse/3918_sum-of-primes-between-number-and-its-reverse_response.txt',
                        'utf-8',
                ),
        );
});

describe('3918_sum-of-primes-between-number-and-its-reverse', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3918_sum-of-primes-between-number-and-its-reverse');
        });
});

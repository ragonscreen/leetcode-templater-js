...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2410_maximum-matching-of-players-with-trainers/2410_maximum-matching-of-players-with-trainers_response.txt',
                        'utf-8',
                ),
        );
});

describe('2410_maximum-matching-of-players-with-trainers', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2410_maximum-matching-of-players-with-trainers');
        });
});

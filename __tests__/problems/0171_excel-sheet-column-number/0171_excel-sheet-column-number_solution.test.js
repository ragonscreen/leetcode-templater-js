...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0171_excel-sheet-column-number/0171_excel-sheet-column-number_response.txt',
                        'utf-8',
                ),
        );
});

describe('0171_excel-sheet-column-number', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0171_excel-sheet-column-number');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1768_merge-strings-alternately/1768_merge-strings-alternately_response.txt',
                        'utf-8',
                ),
        );
});

describe('1768_merge-strings-alternately', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1768_merge-strings-alternately');
        });
});

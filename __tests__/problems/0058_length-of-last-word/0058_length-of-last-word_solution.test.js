...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0058_length-of-last-word/0058_length-of-last-word_response.txt',
                        'utf-8',
                ),
        );
});

describe('0058_length-of-last-word', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0058_length-of-last-word');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2109_adding-spaces-to-a-string/2109_adding-spaces-to-a-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('2109_adding-spaces-to-a-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2109_adding-spaces-to-a-string');
        });
});

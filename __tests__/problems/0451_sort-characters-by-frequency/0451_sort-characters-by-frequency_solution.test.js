...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0451_sort-characters-by-frequency/0451_sort-characters-by-frequency_response.txt',
                        'utf-8',
                ),
        );
});

describe('0451_sort-characters-by-frequency', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0451_sort-characters-by-frequency');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3912_valid-elements-in-an-array/3912_valid-elements-in-an-array_response.txt',
                        'utf-8',
                ),
        );
});

describe('3912_valid-elements-in-an-array', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3912_valid-elements-in-an-array');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1898_maximum-number-of-removable-characters/1898_maximum-number-of-removable-characters_response.txt',
                        'utf-8',
                ),
        );
});

describe('1898_maximum-number-of-removable-characters', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1898_maximum-number-of-removable-characters');
        });
});

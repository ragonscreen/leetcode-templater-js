...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0032_longest-valid-parentheses/0032_longest-valid-parentheses_response.txt',
                        'utf-8',
                ),
        );
});

describe('0032_longest-valid-parentheses', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0032_longest-valid-parentheses');
        });
});

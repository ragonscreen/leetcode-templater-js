...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0921_minimum-add-to-make-parentheses-valid/0921_minimum-add-to-make-parentheses-valid_response.txt',
                        'utf-8',
                ),
        );
});

describe('0921_minimum-add-to-make-parentheses-valid', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0921_minimum-add-to-make-parentheses-valid');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0994_rotting-oranges/0994_rotting-oranges_response.txt',
                        'utf-8',
                ),
        );
});

describe('0994_rotting-oranges', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0994_rotting-oranges');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0229_majority-element-ii/0229_majority-element-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('0229_majority-element-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0229_majority-element-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2033_minimum-operations-to-make-a-uni-value-grid/2033_minimum-operations-to-make-a-uni-value-grid_response.txt',
                        'utf-8',
                ),
        );
});

describe('2033_minimum-operations-to-make-a-uni-value-grid', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2033_minimum-operations-to-make-a-uni-value-grid');
        });
});

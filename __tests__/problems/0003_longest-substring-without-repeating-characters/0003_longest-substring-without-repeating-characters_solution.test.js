...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0003_longest-substring-without-repeating-characters/0003_longest-substring-without-repeating-characters_response.txt',
                        'utf-8',
                ),
        );
});

describe('0003_longest-substring-without-repeating-characters', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0003_longest-substring-without-repeating-characters');
        });
});

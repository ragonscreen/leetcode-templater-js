...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3208_alternating-groups-ii/3208_alternating-groups-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3208_alternating-groups-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3208_alternating-groups-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1631_path-with-minimum-effort/1631_path-with-minimum-effort_response.txt',
                        'utf-8',
                ),
        );
});

describe('1631_path-with-minimum-effort', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1631_path-with-minimum-effort');
        });
});

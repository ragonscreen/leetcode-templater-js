...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0042_trapping-rain-water/0042_trapping-rain-water_response.txt',
                        'utf-8',
                ),
        );
});

describe('0042_trapping-rain-water', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0042_trapping-rain-water');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0017_letter-combinations-of-a-phone-number/0017_letter-combinations-of-a-phone-number_response.txt',
                        'utf-8',
                ),
        );
});

describe('0017_letter-combinations-of-a-phone-number', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0017_letter-combinations-of-a-phone-number');
        });
});

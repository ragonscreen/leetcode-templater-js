...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/3356_zero-array-transformation-ii/3356_zero-array-transformation-ii_response.txt',
                        'utf-8',
                ),
        );
});

describe('3356_zero-array-transformation-ii', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('3356_zero-array-transformation-ii');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1807_evaluate-the-bracket-pairs-of-a-string/1807_evaluate-the-bracket-pairs-of-a-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('1807_evaluate-the-bracket-pairs-of-a-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1807_evaluate-the-bracket-pairs-of-a-string');
        });
});

...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1234_replace-the-substring-for-balanced-string/1234_replace-the-substring-for-balanced-string_response.txt',
                        'utf-8',
                ),
        );
});

describe('1234_replace-the-substring-for-balanced-string', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1234_replace-the-substring-for-balanced-string');
        });
});

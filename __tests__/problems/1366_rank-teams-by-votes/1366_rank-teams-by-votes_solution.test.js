...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1366_rank-teams-by-votes/1366_rank-teams-by-votes_response.txt',
                        'utf-8',
                ),
        );
});

describe('1366_rank-teams-by-votes', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1366_rank-teams-by-votes');
        });
});

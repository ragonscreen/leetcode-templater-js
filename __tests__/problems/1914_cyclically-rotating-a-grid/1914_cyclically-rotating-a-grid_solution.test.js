...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/1914_cyclically-rotating-a-grid/1914_cyclically-rotating-a-grid_response.txt',
                        'utf-8',
                ),
        );
});

describe('1914_cyclically-rotating-a-grid', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('1914_cyclically-rotating-a-grid');
        });
});

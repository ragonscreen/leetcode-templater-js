...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2657_find-the-prefix-common-array-of-two-arrays/2657_find-the-prefix-common-array-of-two-arrays_response.txt',
                        'utf-8',
                ),
        );
});

describe('2657_find-the-prefix-common-array-of-two-arrays', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2657_find-the-prefix-common-array-of-two-arrays');
        });
});

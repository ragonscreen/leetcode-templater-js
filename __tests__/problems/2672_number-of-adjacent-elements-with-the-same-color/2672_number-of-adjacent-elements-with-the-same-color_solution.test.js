...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2672_number-of-adjacent-elements-with-the-same-color/2672_number-of-adjacent-elements-with-the-same-color_response.txt',
                        'utf-8',
                ),
        );
});

describe('2672_number-of-adjacent-elements-with-the-same-color', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2672_number-of-adjacent-elements-with-the-same-color');
        });
});

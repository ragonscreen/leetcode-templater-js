...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/0128_longest-consecutive-sequence/0128_longest-consecutive-sequence_response.txt',
                        'utf-8',
                ),
        );
});

describe('0128_longest-consecutive-sequence', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('0128_longest-consecutive-sequence');
        });
});

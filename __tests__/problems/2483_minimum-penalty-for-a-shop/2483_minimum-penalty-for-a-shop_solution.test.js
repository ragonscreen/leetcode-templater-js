...
beforeAll(async () => {
        SOURCE = JSON.parse(
                await readFile(
                        './__tests__/problems/2483_minimum-penalty-for-a-shop/2483_minimum-penalty-for-a-shop_response.txt',
                        'utf-8',
                ),
        );
});

describe('2483_minimum-penalty-for-a-shop', () => {
        test('solution template', () => {
                ...
                expect(solution).toMatchSnapshot('2483_minimum-penalty-for-a-shop');
        });
});
